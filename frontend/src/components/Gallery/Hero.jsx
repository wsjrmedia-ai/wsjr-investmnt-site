...
import { getGalleryBanner } from '@/lib/getGalleryBanner';
...
export default function Hero({ id, align }) {
  ...
  return (
    <main className="relative md:min-h-screen xl:px-16 lg:px-12 lg:py-10 px-4 pt-4 pb-8 text-white ">
      {/* Hero background using Next.js Image */}
      <div className="absolute inset-0 -z-10 bg-[#071E2F]">
        {banner && (
          <Image
            ...
            blurDataURL="/gallery/herobg.png"
          ...
          <div className="space-y-6 max-w-3xl 3xl:max-w-7xl">
            <div className="lg:pt-12 space-y-6">
              <h1 className="main-heading font-light leading-snug pt-8">
                Inside the <span className="font-bold whitespace-nowrap">Wall Street Jr</span>
                <br />
                Experience
              </h1>

              <p className="text-gray-300 text-fluid">
                Explore moments from our workshops, live sessions, global events, and milestones capturing growth, learning, and leadership in action.
              </p>
