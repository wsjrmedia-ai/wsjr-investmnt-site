      ...
      <section className="grid grid-cols-1 md:grid-cols-2 mt-7">
        ...
        <div className="space-y-6 max-w-6xl px-4 lg:px-20 py-10">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-light leading-snug pt-4">
            <span className="font-bold text-white">Terms &</span>
            <span className="font-bold text-white"> Conditions</span>
          </h1>

          <p className="text-gray-300 text-base sm:text-lg">
            Please review our terms carefully to understand your rights and obligations when using Wall Street Jr Investments website. We’re committed to transparency and trust in every interaction.          </p>
